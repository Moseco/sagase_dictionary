...
class VocabWritings extends Table
  ...
  late final GeneratedColumn<String> info = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      $customConstraints: 'NULL');
  late final GeneratedColumn<int> primaryPair = GeneratedColumn<int>(
  ...
  VocabWritingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return VocabWritingsData(
      ...
      primaryPair: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}primary_pair'])!,
    );
  }
...
class VocabWritingsData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['primary_pair'] = Variable<int>(primaryPair);
    return map;
  }
  ...
  factory VocabWritingsData.fromJson(Map<String, dynamic> json,
    ...
    return VocabWritingsData(
      ...
      primaryPair: serializer.fromJson<int>(json['primaryPair']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'primaryPair': serializer.toJson<int>(primaryPair),
    };
  }
...
class VocabWritingsCompanion extends UpdateCompanion<VocabWritingsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (primaryPair.present) {
      map['primary_pair'] = Variable<int>(primaryPair.value);
    }
    return map;
  }
...
class Vocabs extends Table with TableInfo<Vocabs, VocabsData> {
  ...
  late final GeneratedColumn<String> pos = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      $customConstraints: 'NULL');
  late final GeneratedColumn<int> common = GeneratedColumn<int>(
  ...
  VocabsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return VocabsData(
      ...
      common: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}common'])!,
...
class VocabsData extends DataClass implements Insertable<VocabsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['common'] = Variable<int>(common);
  ...
  factory VocabsData.fromJson(Map<String, dynamic> json,
    ...
    return VocabsData(
      ...
      common: serializer.fromJson<int>(json['common']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'common': serializer.toJson<int>(common),
...
class VocabsCompanion extends UpdateCompanion<VocabsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (common.present) {
      map['common'] = Variable<int>(common.value);
    }
...
class VocabDefinitions extends Table
  ...
  late final GeneratedColumn<String> languageSource = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      $customConstraints: 'NULL');
  late final GeneratedColumn<int> waseieigo = GeneratedColumn<int>(
  ...
  VocabDefinitionsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return VocabDefinitionsData(
      ...
      waseieigo: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}waseieigo'])!,
...
class VocabDefinitionsData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['waseieigo'] = Variable<int>(waseieigo);
  ...
  factory VocabDefinitionsData.fromJson(Map<String, dynamic> json,
    ...
    return VocabDefinitionsData(
      ...
      waseieigo: serializer.fromJson<int>(json['waseieigo']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'waseieigo': serializer.toJson<int>(waseieigo),
...
class VocabDefinitionsCompanion extends UpdateCompanion<VocabDefinitionsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (waseieigo.present) {
      map['waseieigo'] = Variable<int>(waseieigo.value);
    }
...
class SpacedRepetitionDatas extends Table
  ...
  List<String> get customConstraints =>
      const ['PRIMARY KEY(item_id, item_type, front_type)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class SpacedRepetitionDatasData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(itemId, itemType, frontType, interval,
...
class MyDictionaryListsData extends DataClass
  ...
  MyDictionaryListsData copyWith({int? id, String? name, int? timestamp}) =>
...
class MyDictionaryListsCompanion
  ...
  MyDictionaryListsCompanion copyWith(
      {Value<int>? id, Value<String>? name, Value<int>? timestamp}) {
    return MyDictionaryListsCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      timestamp: timestamp ?? this.timestamp,
...
class MyDictionaryListItems extends Table
  ...
  @override
  List<String> get customConstraints =>
      const ['UNIQUE(list_id, vocab_id, kanji_id)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class GrammarLessons extends Table
    with TableInfo<GrammarLessons, GrammarLessonsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GrammarLessonsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GrammarLessonsData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
...
class GrammarLessonsData extends DataClass
    implements Insertable<GrammarLessonsData> {
  final int id;
  final String form;
  final String meaning;
  ...
  factory GrammarLessonsData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GrammarLessonsData(
      id: serializer.fromJson<int>(json['id']),
  ...
  GrammarLessonsData copyWithCompanion(GrammarLessonsCompanion data) {
    return GrammarLessonsData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('GrammarLessonsData(')
          ..write('id: $id, ')
          ..write('form: $form, ')
          ..write('meaning: $meaning, ')
...
class GrammarLessonsCompanion extends UpdateCompanion<GrammarLessonsData> {
  final Value<int> id;
  ...
  GrammarLessonsCompanion.insert({
    ...
    this.practice = const Value.absent(),
        ...
        meaning = Value(meaning),
        jlptLevel = Value(jlptLevel);
  static Insertable<GrammarLessonsData> custom({
    Expression<int>? id,
...
class FlashcardSets extends Table
  ...
  late final GeneratedColumn<String> name = GeneratedColumn<String>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  late final GeneratedColumn<int> usingSpacedRepetition = GeneratedColumn<int>(
      'using_spaced_repetition', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      $customConstraints:
  ...
  late final GeneratedColumn<int> frontType = GeneratedColumn<int>(
      ...
      $customConstraints: 'NOT NULL DEFAULT 0',
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> vocabShowReading = GeneratedColumn<int>(
      ...
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> vocabShowReadingIfRareKanji = GeneratedColumn<
      ...
      defaultValue: const CustomExpression('1'));
  late final GeneratedColumn<int> vocabShowAlternatives = GeneratedColumn<int>(
      'vocab_show_alternatives', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      $customConstraints:
          'NOT NULL DEFAULT 0 CHECK (vocab_show_alternatives IN (0, 1))',
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> vocabShowPitchAccent = GeneratedColumn<int>(
      ...
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> kanjiShowReading = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> vocabShowPartsOfSpeech = GeneratedColumn<int>(
      ...
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> showNote = GeneratedColumn<int>(
  ...
  FlashcardSetsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FlashcardSetsData(
      ...
      usingSpacedRepetition: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}using_spaced_repetition'])!,
      frontType: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}front_type'])!,
      vocabShowReading: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}vocab_show_reading'])!,
      ...
      vocabShowAlternatives: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}vocab_show_alternatives'])!,
      vocabShowPitchAccent: attachedDatabase.typeMapping.read(
      ...
      showNote: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}show_note'])!,
      timestamp: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}timestamp'])!,
...
class FlashcardSetsData extends DataClass
  ...
  final int id;
  final String name;
  final int usingSpacedRepetition;
  final int frontType;
  final int vocabShowReading;
  final int vocabShowReadingIfRareKanji;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<int>(id);
    map['name'] = Variable<String>(name);
    map['using_spaced_repetition'] = Variable<int>(usingSpacedRepetition);
    map['front_type'] = Variable<int>(frontType);
    map['vocab_show_reading'] = Variable<int>(vocabShowReading);
    map['vocab_show_reading_if_rare_kanji'] =
        Variable<int>(vocabShowReadingIfRareKanji);
  ...
  factory FlashcardSetsData.fromJson(Map<String, dynamic> json,
    ...
    return FlashcardSetsData(
      ...
      name: serializer.fromJson<String>(json['name']),
      usingSpacedRepetition:
          serializer.fromJson<int>(json['usingSpacedRepetition']),
      frontType: serializer.fromJson<int>(json['frontType']),
      vocabShowReading: serializer.fromJson<int>(json['vocabShowReading']),
      vocabShowReadingIfRareKanji:
          serializer.fromJson<int>(json['vocabShowReadingIfRareKanji']),
      vocabShowAlternatives:
          serializer.fromJson<int>(json['vocabShowAlternatives']),
      vocabShowPitchAccent:
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'name': serializer.toJson<String>(name),
      'usingSpacedRepetition': serializer.toJson<int>(usingSpacedRepetition),
      'frontType': serializer.toJson<int>(frontType),
      'vocabShowReading': serializer.toJson<int>(vocabShowReading),
      'vocabShowReadingIfRareKanji':
          serializer.toJson<int>(vocabShowReadingIfRareKanji),
  ...
  FlashcardSetsData copyWith(
          {int? id,
          String? name,
          int? usingSpacedRepetition,
          int? frontType,
          int? vocabShowReading,
          int? vocabShowReadingIfRareKanji,
...
class FlashcardSetsCompanion extends UpdateCompanion<FlashcardSetsData> {
  final Value<int> id;
  final Value<String> name;
  final Value<int> usingSpacedRepetition;
  final Value<int> frontType;
  final Value<int> vocabShowReading;
  final Value<int> vocabShowReadingIfRareKanji;
  ...
  static Insertable<FlashcardSetsData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<int>? usingSpacedRepetition,
    Expression<int>? frontType,
    Expression<int>? vocabShowReading,
    Expression<int>? vocabShowReadingIfRareKanji,
  ...
  FlashcardSetsCompanion copyWith(
      {Value<int>? id,
      Value<String>? name,
      Value<int>? usingSpacedRepetition,
      Value<int>? frontType,
      Value<int>? vocabShowReading,
      Value<int>? vocabShowReadingIfRareKanji,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (usingSpacedRepetition.present) {
      map['using_spaced_repetition'] =
          Variable<int>(usingSpacedRepetition.value);
    }
    if (frontType.present) {
      map['front_type'] = Variable<int>(frontType.value);
    }
    if (vocabShowReading.present) {
      map['vocab_show_reading'] = Variable<int>(vocabShowReading.value);
    }
    if (vocabShowReadingIfRareKanji.present) {
      map['vocab_show_reading_if_rare_kanji'] =
          Variable<int>(vocabShowReadingIfRareKanji.value);
    }
    if (vocabShowAlternatives.present) {
      map['vocab_show_alternatives'] =
          Variable<int>(vocabShowAlternatives.value);
    }
    if (vocabShowPitchAccent.present) {
      map['vocab_show_pitch_accent'] =
          Variable<int>(vocabShowPitchAccent.value);
    }
    ...
    if (showNote.present) {
      map['show_note'] = Variable<int>(showNote.value);
    }
    if (timestamp.present) {
      map['timestamp'] = Variable<int>(timestamp.value);
    }
